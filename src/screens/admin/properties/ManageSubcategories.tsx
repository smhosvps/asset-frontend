...
export default function ManageCategory() {
  ...
  const [updateSubCategory, { isLoading: isUpdating, isSuccess, error }] =
    useUpdateSubCategoryMutation();
  ...
  const handleOpenEditModal = (category: Category) => {
    ...
    setEditedSubCategoryName(category.subCategoryName);
              ...
              <tr className="border-b bg-muted/50">
                ...
                <th className="py-3 px-4 text-left">
                  <button
                    ...
                    className="flex items-center gap-1 hover:text-primary"
                  >
                    Sub Category Name {getSortIcon("subCategoryName")}
                  </button>
                </th>
                ...
                <th className="py-3 px-4 text-left">Delete Sub Sub-Category</th>
              </tr>
            </thead>
            <tbody>
                ...
                <tr key={category._id} className="border-b hover:bg-muted/50">
                  ...
                  <td className="py-3 px-4 text-sm">
                    <Button
                      ...
                      className="text-sm"
                    >
                      {isDeleting ? "Editing" : "Delete Sub-Categor"}
                    </Button>
                  </td>
                </tr>
              ))}
